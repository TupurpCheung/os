...
BOTPAK	EQU		0x00280000		; bootpack存放的位置
...
CYLS	EQU		0x0ff0			; 
LEDS	EQU		0x0ff1
VMODE	EQU		0x0ff2			; 显示模式存放的位置
SCRNX	EQU		0x0ff4			; 屏幕分辨率X
SCRNY	EQU		0x0ff6			; 屏幕分辨率Y
VRAM	EQU		0x0ff8			; 显存地址存放的位置

		ORG		0xc200			; 当前程序从0xc200开始

; 夋柺儌乕僪傪愝掕

		MOV		AL,0x13			; VGA模式320x200x8bit真彩
		MOV		AH,0x00
		INT		0x10
		MOV		BYTE [VMODE],8	; 
		MOV		WORD [SCRNX],320
		MOV		WORD [SCRNY],200
		MOV		DWORD [VRAM],0x000a0000 ;设置显存空间
